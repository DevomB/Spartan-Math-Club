...
/**
 * Ghost formulas move with the panels (100% of panel speed), so a ghost at
 * `left` sits at (left − 100·i)% of the screen while panel i is in view. That keeps each
 * ghost on its own panel, never bleeding into a neighbor. Each is placed in
